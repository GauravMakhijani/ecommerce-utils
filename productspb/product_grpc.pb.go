...
type ProductServiceClient interface {
	...
	UpdateProductQTY(ctx context.Context, in *UpdateProductQTYRequest, opts ...grpc.CallOption) (*UpdateProductQTYResponse, error)
}
...
func (c *productServiceClient) UpdateProductQTY(ctx context.Context, in *UpdateProductQTYRequest, opts ...grpc.CallOption) (*UpdateProductQTYResponse, error) {
	out := new(UpdateProductQTYResponse)
	err := c.cc.Invoke(ctx, "/products.ProductService/UpdateProductQTY", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProductServiceServer) UpdateProductQTY(context.Context, *UpdateProductQTYRequest) (*UpdateProductQTYResponse, error) {
...
func _ProductService_UpdateProductQTY_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateProductQTYRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).UpdateProductQTY(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/products.ProductService/UpdateProductQTY",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).UpdateProductQTY(ctx, req.(*UpdateProductQTYRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProductService_UpdateProductQTY_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "utils/product.proto",
}
